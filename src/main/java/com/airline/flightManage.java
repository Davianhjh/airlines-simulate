...
public class flightManage {
	...
	public flightManageRes getFlightList(int dayLap) throws SQLException {
		...
		while(ret.next()) {
			...
			list.setFlightDate(ret.getString(2));
			list.setDptAirport(ret.getString(3));
			list.setArvAirport(ret.getString(4));
			list.setDepTime(ret.getString(5));
			list.setArrTime(ret.getString(6));
			System.out.println(ret.getString(5));
			System.out.println(ret.getString(6));
			flights.add(list);
		}
